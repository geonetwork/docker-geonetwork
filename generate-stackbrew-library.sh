...
declare -A dirExclude=(
	...
	[4.2.0]=1 [4.2.1]=1 [4.2.2]=1 [4.2.3]=1 [4.2.4]=1 [4.2.5]=1 [4.2.6]=1 [4.2.7]=1 [4.2.8]=1 [4.2.9]=1 [4.2.10]=1 [4.2.11]=1 [4.2.12]=1 [4.2.13]=1 [4.2.14]=1 [4.2.15]=1
	[4.4.0]=1 [4.4.1]=1 [4.4.2]=1 [4.4.3]=1 [4.4.4]=1 [4.4.5]=1 [4.4.6]=1 [4.4.7]=1 [4.4.8]=1 [4.4.9]=1
)
